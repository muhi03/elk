...
import { resetEngagementObjectsOnUncheck } from '~/composables/settings'
...
<template>
    <MainContent back-on-small-screen>
        ...
        <section>
            ...
            <SettingsToggleItem
                :checked="
                    getPreferences(userSettings, 'hideAltIndicatorOnPosts')
                "
            ...
            <SettingsToggleItem
                :checked="
                    getPreferences(userSettings, 'hideGifIndicatorOnPosts')
                "
            ...
            >
                {{
                    $t(
                        'settings.preferences.optimize_for_low_performance_device'
                    )
                }}
            </SettingsToggleItem>
            <SettingsToggleItem
            ...
            >
                ...
                <template #description>
                    {{
                        $t(
                            'settings.preferences.enable_data_saving_description'
                        )
                    }}
                </template>
            </SettingsToggleItem>
        ...
        <section>
            ...
            >
                ...
                <template #description>
                    {{
                        $t(
                            'settings.preferences.hide_username_emojis_description'
                        )
                    }}
                </template>
            </SettingsToggleItem>
        ...
        <section>
            ...
            <SettingsToggleItem
                :checked="
                    getPreferences(userSettings, 'experimentalEmbeddedMedia')
                "
            ...
            <SettingsToggleItem
                :checked="
                    getPreferences(userSettings, 'experimentalVirtualScroller')
                "
            ...
            <SettingsToggleItem
                :checked="
                    getPreferences(userSettings, 'experimentalGitHubCards')
                "
            ...
            <SettingsToggleItem
                :checked="
                    getPreferences(userSettings, 'experimentalUserPicker')
                "
            ...
            <SettingsToggleItem
                ...
                "
                @click="
                    resetEngagementObjectsOnUncheck(
                        'experimentalEngagementInsights'
                    )
                "
            >
                ...
                <template #description>
                    {{
                        $t(
                            'settings.preferences.engagement_insights_description'
                        )
                    }}
                </template>
            </SettingsToggleItem>
